...
useEffect(() => {
  ...
  if (success && registeredPatientId && !showSuccess && !hasNotified) {
    ...
    console.log('PatientFormModal - Sending patient data:', patientDataWithAge);
...
}, [success, registeredPatientId, patientData, showSuccess, hasNotified, formData, onPatientRegistered, onClose]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!isFormValid()) {
      ...
      const allFields: (keyof FormData)[] = [
        "hospitalNumber", "firstName", "lastName", "insuranceStatus",
              ...
              {showSuccess && (
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-sm text-green-600">
                    ✓ Patient registered successfully! Proceeding to emergency bill...
                  </p>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    />
                    {getFieldError("dateOfBirth") && (
                      <p className="mt-1 text-xs text-red-600">{getFieldError("dateOfBirth")}</p>
                    )}
                  </div>
