    ...
    <div className="max-w-5xl mx-auto bg-white rounded-xl border shadow-sm">
      ...
      <Section title="Patient Details">
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <Item label="Hospital Name" value={currentBill.department || "N/A"} />
      ...
      {currentBill.productServices && currentBill.productServices.length > 0 && (
        <Section title="Services Billed">
          <div className="overflow-hidden rounded-lg border">
            {/* Table Header */}
            <div className="grid grid-cols-6 bg-green-50 text-xs font-medium text-gray-600 px-4 py-3">
              <div>Name</div>
              <div>Description</div>
              <div>Code</div>
            ...
            {currentBill.productServices.map((service, index) => {
              ...
              return (
                <div
                  ...
                  className="grid grid-cols-6 px-4 py-3 border-t text-sm hover:bg-gray-50"
                >
