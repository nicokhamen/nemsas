      ...
      <div className="bg-white px-5 py-5 shadow-sm">
        ...
        {loading && !emergencyBillPatients ? (
          ...
          <EmptyState
            ...
            description={
              error ? "Failed to load patients" : "No patients found for this review."
            }
          />
        ) : (
              ...
              <table className="min-w-[1050px] w-full border-collapse text-left text-sm">
                <thead className="bg-[#F1FAF7] text-gray-500">
                  <tr>
                    ...
                    <th className="px-4 py-4 font-semibold">Insurance Status</th>
                ...
                <tbody>
                  {patients.map((patient) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4">{patient.firstName || "N/A"}</td>
                      ...
                      <td className="max-w-[120px] truncate px-4 py-4" title={patient.address || "N/A"}>
                        {patient.address || "N/A"}
                      </td>
                      <td className="max-w-[120px] truncate px-4 py-4" title={patient.email || "N/A"}>
                        {patient.email || "N/A"}
                      </td>
                      <td className="px-4 py-4">
