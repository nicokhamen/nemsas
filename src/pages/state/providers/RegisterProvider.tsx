...
const RegisterProvider: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.hospitalAdress) newErrors.hospitalAdress = "Hospital address is required";
    ...
    if (!formData.bankVeririfationNumber) newErrors.bankVeririfationNumber = "BVN is required";
    if (!formData.stateLicenseNumber) newErrors.stateLicenseNumber = "License number is required";
    ...
    formData.contacts.forEach((contact, index) => {
      if (!contact.name) newErrors[`contact_name_${index}`] = "Contact name is required";
      if (!contact.designation) newErrors[`contact_designation_${index}`] = "Designation is required";
      if (!contact.email) newErrors[`contact_email_${index}`] = "Contact email is required";
      if (!contact.phoneNumber) newErrors[`contact_phone_${index}`] = "Contact phone is required";
